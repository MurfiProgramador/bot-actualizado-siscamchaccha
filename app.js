...
const flowPrincipal = addKeyword(['hola','ole','alo','volver','volver','atras'])
    ...
    .addAnswer(
        [
            ...
            '👨‍💻 *[ 1 ]* *Informacion.*  Para enviarle el link de pagina y revise nuestros productos y servicios.',
            '🛒 *[ 2 ]* *Productos.*   Para ver la lista de productos y marcas que trabajamos.',
            '👷 *[ 3 ]* *Instalacion.*  Conocer precios de instalacion. (los precios son aprox)',
            '🛠️ *[ 4 ]* *Mantenimiento.*  Registrar un mantenimiento o consultar.',
        ],
        null,
        null,
